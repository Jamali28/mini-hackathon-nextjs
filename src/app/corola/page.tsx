        ...
        <div>
            <section>
              <div className="grid grid-col-12 grid-row-12  justify-center w-full h-screen bg-zinc-100">
                ...
                <h1 className="font-bold text-3xl text-center text-black underline">Toyota Corolla 2024 Price in Pakistan, 
                  Images, Reviews &amp; Specs</h1>
                  <div className="  row-span-8 col-span-8 pl-[500px] pt-7 ">
              <Image alt="Corolla car in Red color" loading="lazy" width="500" height="500" decoding="async" data-nimg="1" src="/corola.jpg"></Image>
                </div> 
